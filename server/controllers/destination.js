...
const getDestinationInfo = async (req, res) => {
    try {
        ...
        - Name of the destination, state, country, description, nearest airport, coordinates, best months to travel in (json key has to be named best_months_to_travel_in), local currency, timezone, and website.
